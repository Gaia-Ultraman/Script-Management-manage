// 官网介绍 https://github.com/bubkoo/natsort
module.exports = function natsort(options) {
  if (options === void 0) {
    options = {};
  }
  var ore = /^0/;
  ...
  var normalize = options.insensitive
    ? function (s) {
        return toLowerCase.call('' + s).replace(tre, '');
      }
    : function (s) {
  ...
  function parse(s, l) {
    ...
    return (
      ((!s.match(ore) || l === 1) && parseFloat(s)) || s.replace(sre, ' ').replace(tre, '') || 0
    );
  }
  return function (a, b) {
